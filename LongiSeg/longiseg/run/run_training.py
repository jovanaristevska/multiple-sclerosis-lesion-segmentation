...
def get_trainer_from_args(dataset_name_or_id: Union[int, str],
    ...
    nnunet_trainer = recursive_find_python_class(join(longiseg.__path__[0], "training", "LongiSegTrainer"),
    ...
    assert issubclass(nnunet_trainer, nnUNetTrainerNoLongi), 'The requested nnunet trainer class must inherit from ' \
...
def maybe_load_checkpoint(nnunet_trainer: nnUNetTrainerNoLongi, continue_training: bool, validation_only: bool,
...
def run_training(dataset_name_or_id: Union[str, int],
                 ...
                 trainer_class_name: str = 'nnUNetTrainerNoLongi',
                 plans_identifier: str = 'nnUNetPlans',
...
def run_training_entry():
    ...
    parser.add_argument('-tr', type=str, required=False, default='nnUNetTrainerNoLongi',
                        help='[OPTIONAL] Use this flag to specify a custom trainer. Default: nnUNetTrainerNoLongi')
