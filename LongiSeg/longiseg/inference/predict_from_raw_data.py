...
from longiseg.inference.data_iterators import PreprocessAdapterFromNpy, preprocessing_iterator_fromfiles, \
...
from longiseg.utilities.file_path_utilities import get_output_folder, check_workers_alive_and_busy
...
class nnUNetPredictor:
    ...
    def manual_initialization(self, network: nn.Module, plans_manager: PlansManager,
        ...
        self.label_manager = plans_manager.get_label_manager(dataset_json)
        allow_compile = True
        allow_compile = allow_compile and ('LongiSeg_compile' in os.environ.keys()) and (
                    os.environ['LongiSeg_compile'].lower() in ('true', '1', 't'))
