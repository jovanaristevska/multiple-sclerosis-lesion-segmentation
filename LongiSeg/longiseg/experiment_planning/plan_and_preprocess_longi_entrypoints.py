...
from longiseg.experiment_planning.plan_and_preprocess_api import extract_fingerprints, plan_experiments, preprocess


def extract_fingerprint_longi_entry():
    import argparse
    ...
    parser.add_argument('-fpe', type=str, required=False, default='DatasetFingerprintExtractorLongiSeg',
...
def plan_experiment_longi_entry():
    import argparse
    parser = argparse.ArgumentParser()
    parser.add_argument('-d', nargs='+', type=int,
                        help="[REQUIRED] List of dataset IDs. Example: 2 4 5. This will run fingerprint extraction, experiment "
    ...
    parser.add_argument('-preprocessor_name', default='LongiSegPreprocessor', type=str, required=False,
                        help='[OPTIONAL] DANGER ZONE! Sets a custom preprocessor class. This class must be located in '
                             'longiseg.preprocessing. Default: \'LongiSegPreprocessor\'. Changing this may affect your '
...
def plan_and_preprocess_longi_entry():
    import argparse
    parser = argparse.ArgumentParser()
    parser.add_argument('-d', nargs='+', type=int,
                        help="[REQUIRED] List of dataset IDs. Example: 2 4 5. This will run fingerprint extraction, experiment "
...
if __name__ == '__main__':
    plan_and_preprocess_longi_entry()
