...
from longiseg.preprocessing.resampling.utils import recursive_find_resampling_fn_by_name
import longiseg
from batchgenerators.utilities.file_and_folder_operations import load_json, join

from longiseg.imageio.reader_writer_registry import recursive_find_reader_writer_by_name
from longiseg.utilities.find_class_by_name import recursive_find_python_class
from longiseg.utilities.label_handling.label_handling import get_labelmanager_class_from_plans
...
class ConfigurationManager:
    ...
    def preprocessor_class(self) -> Type[DefaultPreprocessor]:
        preprocessor_class = recursive_find_python_class(join(longiseg.__path__[0], "preprocessing"),
                                                         self.preprocessor_name,
                                                         current_module="longiseg.preprocessing")
