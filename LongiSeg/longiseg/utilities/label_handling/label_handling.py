...
import longiseg
from longiseg.inference.export_utils import insert_crop_into_image
from longiseg.utilities.find_class_by_name import recursive_find_python_class
from longiseg.utilities.helpers import softmax_helper_dim0
...
def get_labelmanager_class_from_plans(plans: dict) -> Type[LabelManager]:
    if 'label_manager' not in plans.keys():
        ...
        labelmanager_class = recursive_find_python_class(join(longiseg.__path__[0], "utilities", "label_handling"),
                                                         plans['label_manager'],
                                                         current_module="longiseg.utilities.label_handling")
