...
# SLURM SETTINGS
##############################
#SBATCH --job-name=LongiSeg_all_folds
...
singularity exec --nv \
    ...
    bash -c "
        ...
        # echo '========================================'
        # python3 -u /home/hpc/users/jovana.ristevska/.local/bin/LongiSeg_train 001 3d_fullres 1 --npz
        # echo '========================================'
        # echo 'Starting fold 2 training...'
        # echo '========================================'
        # python3 -u /home/hpc/users/jovana.ristevska/.local/bin/LongiSeg_train 001 3d_fullres 2 --npz

        echo '========================================'
        echo 'Starting fold 3 training...'
        echo '========================================'
        python3 -u /home/hpc/users/jovana.ristevska/.local/bin/LongiSeg_train 001 3d_fullres 3 --npz
        echo '========================================'
        echo 'Starting fold 4 training...'
        echo '========================================'
        python3 -u /home/hpc/users/jovana.ristevska/.local/bin/LongiSeg_train 001 3d_fullres 4 --npz
